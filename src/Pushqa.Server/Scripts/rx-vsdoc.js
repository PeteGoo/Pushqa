...
var CompositeDisposable = root.CompositeDisposable = (function () {
    ...
    CompositeDisposable.prototype.count = function () {
        ...
        /// </summary>
        /// <returns>The number of disposables contained in the CompositeDisposable.</returns>
        return 0;
    };
    ...
    CompositeDisposable.prototype.isDisposed = function () {
        ...
        /// </summary>
        /// <returns type="Boolean">true if the object is disposed; otherwise, false.</returns>
        return false;
    };
...
var SingleAssignmentDisposable = root.SingleAssignmentDisposable = (function () {
    ...
    SingleAssignmentDisposable.prototype.isDisposed = function () {
        ...
        /// Gets a value that indicates whether the object is disposed.
        /// </summary>
        /// <returns type="Boolean">Value indicating whether the object is disposed.</returns>
        return false;
    };
...
Observable.merge = function (scheduler) {
    ...
    /// &#10;
    /// &#10;1 - merged = Rx.Observable.merge(scheduler, /* argument list */ xs, ys, zs);
    /// &#10;2 - merged = Rx.Observable.merge(scheduler, /* array */ [xs, ys, zs]);
    /// </summary>
